				...
				<div class="card mb-4">
					<div class="card-header">
						<div style = "float: left;">
							<i class="far fa-grin-wink"></i>&nbsp; 얼굴 등록
						</div>
					...
					<!-- 주의사항 넣기 !!!!!!!!!!!!!!!!!!!!!!!!!-->
						<div class="card text-white bg-dark mb-3" style="max-width: auto; text-align : center;">
							  ...
							  <div class="card-body">
							    ...
							    <p class="card-text" style="font-family: 'GowunDodum-Regular'; font-size:20px;">영상을 보고 얼굴이 잘 보이는지 확인해주십시오.<br>
									너무 어두운 곳이나 역광이 생기지 않도록 주의하십시오. </p>
							  </div>
						</div>
						<div style="padding-top:20px; text-align : center;  font-size:20px;">
							<div style = " font-family: 'GowunDodum-Regular';">인물 등록을 시작하시겠습니까? &nbsp;</div>
							<div style = "padding-top:15px;">
								<button id="btn1" class="btn btn-warning"onclick="location.href='/face2'" style = "width:150px;">Yes</button>
							</div>
